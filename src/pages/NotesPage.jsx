...
export default function NotesPage() {
  ...
  return (
    <div className="max-w-[860px] mx-auto px-6 pt-28 pb-20">
      ...
      <Link
        to="/"
        className="ff-body text-[14px] inline-block mb-10 transition-colors duration-200 hover:text-white"
      ...
      <div ref={headerRef} style={{ opacity: 0 }}>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {["# announcement", "# from the founder"].map((tag) => (
            <span
              key={tag}
              className="text-[12px] ff-body font-medium px-4 py-1.5 rounded-full"
        ...
        {notes.map((note, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              <span
                className="text-[12px] ff-body font-medium px-3 py-1 rounded-full"
                style={{ background: "var(--accent-red)", color: "#fff" }}
              >
                {note.tag}
              </span>
            ...
            {/* Title */}
            <h3
              className="ff-display font-bold mb-4"
